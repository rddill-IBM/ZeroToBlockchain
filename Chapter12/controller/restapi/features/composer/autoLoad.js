...
/**
 * getAlertPort is used to return the port number for socket interactions so that 
 * the browser can receive asynchronous notifications of work in process. 
 * This helps the user understand the current status of the auto load process. 
 * @param {express.req} req - the inbound request object from the client
 * @param {express.res} res - the outbound response object for communicating back to client
 ...
 * @function
 */
exports.getAlertPort = function(req, res, next) {
    let _conn = svc.createAlertSocket();
    res.send({'port': _conn.socket});
} 

/**
 * getFinanceAlertPort is used to return the port number for socket interactions so that 
 * the browser can receive asynchronous notifications of work in process. 
 * This helps the user understand the current status of the auto load process. 
 * @param {express.req} req - the inbound request object from the client
 * @param {express.res} res - the outbound response object for communicating back to client
 ...
 * @function
 */
exports.getFinanceAlertPort = function(req, res, next) {
    let _conn = svc.createFinanceAlertSocket();
    res.send({'port': _conn.socket});
} 
