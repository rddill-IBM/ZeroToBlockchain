...
var sh_alerts = [];
var sh_notify = '#shipper_notify';
var sh_count = '#shipper_count';
var sh_id;
/**
...
{
  _target.empty();
  let _str = ""; let _date = ""; var _statusText;  
  ...
  {(function(_idx, _arr)
    ...
    _statusText = '';
      ...
      _button = '<th><button id="sh_btn_'+_idx+'">'+textPrompts.orderProcess.ex_button+'</button></th>'
      _action += "</select>";
